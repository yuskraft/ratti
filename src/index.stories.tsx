...
const meta = {
  ...
  argTypes: {
    ...
    value: {
      control: { type: 'number', min: 0 },
      description: 'Controlled rating value. If set, component ignores defaultValue and relies on onChange to update.',
      table: {
    ...
    readOnly: {
      control: 'boolean',
      description: 'Whether the star rating is read-only (prevents user interaction)',
    },
    precision: {
      control: { type: 'number', min: 0.1, max: 1, step: 0.1 },
      description: 'Rating precision (e.g., 0.5 for half stars, 1 for full stars)',
    },
    onChange: {
      action: 'changed',
    ...
    onHoverChange: {
      action: 'hoverChanged',
      description: 'Callback fired when the temporary hover rating changes (0 when mouse leaves)',
    },
    onBlur: {
      action: 'blurred',
    ...
    activeColorsEnabled: {
      control: 'boolean',
      description: 'Whether to enable rating colors (behavior depends on variant)',
    },
    customActiveColors: {
      control: 'object',
      description: 'Optional array of custom colors for rating levels (e.g., ["#ff0000", "#ffa500", ...])',
    },
    variant: {
      control: { type: 'radio' },
      options: ['default', 'circle', 'square'] satisfies StarRatingVariant[],
      description: 'Visual variant of the stars (default, circle background, square background)',
    },
    svgPathD: {
      control: 'text',
      description: 'Custom SVG path data (d attribute) for the icon.',
      defaultValue: "M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z",
    },
    className: {
      control: 'text',
...
export const CircleVariantReadOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'A read-only star rating with the `circle` variant.',
      },
    },
  },
};
