/**biome-ignore-alllint/a11y/noStaticElementInteractions:<explanation>*/
import {
  type ForwardedRef,
  forwardRef,
  useEffect,
      ...
      >
        {[...Array(maxRating)].map((_, index) => {
          ...
          if (isActive) {
            ...
            fillPercentage = roundToPrecision(fractionalPart, precision);
          ...
          return (
            <div
              role="presentation"
              key={starId}
              className={`${itemClasses} star-button`}
              onClick={isInteractive ? (e) => handleClick(e, index) : undefined}
              onMouseEnter={
                isInteractive ? (e) => handleMouseEnter(e, index) : undefined
              }
